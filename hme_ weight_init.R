...
new_thetas <- c(coef(z_g_z_expert_mod), coef(o_g_z_expert_mod), coef(z_g_o_expert_mod), coef(o_g_o_expert_mod), coef(top_gate_mod), coef(o_g_z_gate_mod))
old_thetas <- c(z_g_z_expert_param, o_g_z_expert_param, z_g_o_expert_param, o_g_o_expert_param, top_gate_param, o_g_z_gate_param)
...
### Debugging
print(paste(i, format(round(conv,2), nsmall = 3) ))
